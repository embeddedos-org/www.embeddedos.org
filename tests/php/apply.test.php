...
equals(
    ...
    '[Application] Ada Lovelace (Volunteer)',
    encode_subject('[Application] Ada Lovelace (Volunteer)')
);
equals('an empty subject is left alone', '', encode_subject(''));
$longAscii = '[Application] ' . str_repeat('a', 200);
...
$ack = 'Application received — EmbeddedOS Research Foundation';
...
// A non-ASCII applicant name reaches the staff subject, and a long one must
// fold into words of at most 75 characters each.
$long = '[Application] ' . str_repeat('é', 60) . ' — ' . str_repeat('ü', 40);
