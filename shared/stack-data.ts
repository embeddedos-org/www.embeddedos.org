  ...
  projects: [
    {
      ...
      language: "C",
      description:
        "SMP multi-core RTOS with sub-1μs context switch, A/B OTA, TPM 2.0.",
    },
    {
      name: "eBoot",
    ...
    },
    {
      ...
      language: "HTML",
      description:
        "Hardware designs, EE docs, board datasheets for multiple EmbeddedOS products.",
    },
    {
      name: "eNI",
    ...
    },
    {
      ...
      language: "C",
      description:
        "14-channel EEG, sEMG gesture recognition, TENS therapy wearable.",
    },
    {
      name: "HealthKey-Ulta",
    ...
    },
    {
      ...
      language: "TypeScript",
      description:
        "Full office suite: eDocs, eSheets, eSlides, ePlanner, eNotes",
    },
    {
      name: "eApps",
      ...
      language: "HTML",
      description:
        "EoS Unified Marketplace and App Store for all EmbeddedOS applications.",
    },
    {
      ...
      language: "TypeScript",
      description:
        "10 pages, Stripe donation portal, GPS volunteer matching, admin dashboard.",
    },
    {
      ...
      language: "HTML",
      description:
        "developer documentation, API references, and project guides.",
    },
    {
      name: ".github",
  ...
  roadmap: [
    {
      ...
      repos: ["eNI", "eIPC", "eAI"],
      useCase:
        "Intelligent edge node with neural-interface input. ENI ➜ EIPC ➜ eAI.",
      shipped: true,
      status: "Shipped",
    },
    {
    ...
    },
    {
      version: "0.3",
      profile: "smart-edge",
      repos: ["eos", "eBoot", "ebuild", "eIPC", "eAI"],
    ...
    },
    {
      version: "0.5",
      profile: "appsuite",
      repos: ["eApps", "eOffice", "eBrowser", "eDB"],
      useCase:
        "User-facing applications stack (server + browser + office + DB).",
      shipped: false,
      status: "Planned",
    },
    {
      version: "1.0",
      profile: "full-system",
      repos: ["All canonical 13 (sans dev tools)"],
