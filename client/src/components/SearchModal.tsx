                  ...
                  <>
                    ...
                    {items
                      ...
                      .map((item, idx) => (
                        ...
                        >
                          <span
                            className={`flex-shrink-0 ${selected === idx ? "text-[#F97316]" : "text-white/30"}`}
                          >
                            {PAGE_ICONS[item.path] ?? (
                          ...
                          <ArrowRight
                            className={`w-3.5 h-3.5 flex-shrink-0 transition-opacity ${selected === idx ? "opacity-100 text-[#F97316]" : "opacity-0"}`}
                          />
                        </button>
                      ))}
                      ...
                      searchQuery.data.repos.length > 0 && (
                        <>
                          ...
                          {items
                            ...
                            .map((item, idx) => {
                              const absIdx =
                                items.filter(i => i.type === "page").length +
                                idx;
                              return (
                                <button
                                  key={item.path}
                                ...
                                >
                                  <span
                                    className={`flex-shrink-0 ${selected === absIdx ? "text-[#22D3EE]" : "text-white/30"}`}
                                  >
