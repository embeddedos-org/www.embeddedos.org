...
export default function ProductEoS() {
  return (
    <ProductDetailPage
      ...
      heroImage="/media/product-eos-kernel_0ca24d8d.jpg"
      ...
      usageExamples={[
        ...
        },
        {
          ...
          scenario:
            "A CAN-to-Ethernet gateway bridging vehicle CAN bus messages to a cloud backend over LTE.",
      ...
      features={[
        ...
        },
        {
          ...
          desc: "UART, SPI, I²C, GPIO, CAN, USB, ETH, ADC, PWM, Timer, DMA, RTC, Crypto, and 20 more — identical API across all architectures.",
        },
        {
          name: "7 CPU Architectures",
          desc: "ARM Cortex-M/A/R, RISC-V RV32/RV64, x86, MIPS, ARC, Xtensa. Same application code runs on all.",
        },
        {
          name: "Capability-Based Security",
          desc: "Process isolation with capability tokens. Tasks can only access peripherals they hold a capability for. Secure world handoff for TrustZone.",
        },
        {
          name: "< 4 KB Footprint",
          desc: "Bare scheduler + HAL fits in 4 KB flash and 2 KB RAM — suitable for the smallest Cortex-M0 devices.",
        },
        {
          name: "41 BSP Profiles",
          desc: "Ready-made board support packages for sensor nodes, gateways, infotainment, robotics, and edge servers.",
        },
        {
          name: "IPC Primitives",
          desc: "Message queues, shared memory, semaphores, mutexes, condition variables, and event flags — all with bounded timing.",
        },
        {
          name: "Power Management",
          desc: "Tickless idle, dynamic voltage/frequency scaling, and deep-sleep modes. Integrates with eos_power API for < 5 µA standby.",
        },
      ]}
      specs={[
        { key: "Kernel Language", value: "C11 (ISO/IEC 9899:2011)" },
        {
          key: "Scheduler",
          value:
            "Preemptive priority-based RT scheduler with time-slicing; SMP and AMP multicore modes",
        },
        {
          key: "HAL Peripheral Classes",
          value:
            "33 (UART, SPI, I²C, GPIO, CAN, USB, ETH, ADC, PWM, Timer, DMA, RTC, Crypto, …)",
        },
        {
          key: "Product Profiles",
          value:
            "41 ready-made BSP profiles (sensor nodes, gateways, infotainment, robotics, edge servers)",
        },
        {
        ...
        },
        {
          key: "IPC Primitives",
          value:
            "Message queues, shared memory, semaphores, mutexes, condition variables, event flags",
        },
        {
          key: "Security Model",
          value:
            "Capability-based access control; process isolation; secure world handoff",
        },
        {
          key: "License",
      ...
      pairs={[
        {
          name: "eBootloader",
          route: "/product-eboot",
          desc: "Portable, secure, fail-safe boot for 24 boards across 10 architectures.",
        },
        {
          name: "EAI",
          route: "/product-eai",
          desc: "On-device LLM inference, ReAct agents, LoRA, and federated learning — at edge power budgets.",
        },
        {
          name: "EIPC",
          route: "/product-eipc",
