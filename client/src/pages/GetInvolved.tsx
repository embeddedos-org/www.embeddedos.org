          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {REPOS.map((repo, i) => (
              ...
              >
                <Github
                  size={20}
                  className="text-white/40 group-hover:text-[#F97316] transition-colors shrink-0"
                />
                <div>
                  <div className="font-semibold text-white text-sm group-hover:text-[#F97316] transition-colors">
                    embeddedos-org / {repo.name}
                  </div>
      ...
      <section className="py-16 bg-[#080F1E] text-center">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <p className="text-white/50 mb-2">
            Foundation. 501(c)(3). Community-driven. Free forever.
          </p>
          <p className="text-white/40 text-sm mb-6">
            EmbeddedOS is licensed under the MIT License. All hardware designs
            are open hardware. We will never add paywalls, ads, or proprietary
            features.
          </p>
          <a
            href="https://github.com/embeddedos-org"
