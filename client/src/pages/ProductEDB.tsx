...
export default function ProductEDB() {
  return (
    <ProductDetailPage
      ...
      heroImage="/media/product-edb_9cd0fe0e.jpg"
      ...
      usageExamples={[
        ...
        },
        {
          ...
          scenario:
            "eDB stores metadata for all deployed eAI models, including version, quantization, and performance benchmarks.",
      ...
      features={[
        {
          name: "SQL Interface",
          desc: "SQLite-compatible SQL: CREATE, INSERT, SELECT, UPDATE, DELETE, JOIN. Prepared statements prevent injection.",
        },
        {
          name: "Document Store",
          desc: "Schema-less JSON document collections for flexible, evolving data structures.",
        },
        {
          name: "Key-Value Store",
          desc: "O(1) KV store for configuration, counters, and flags. Atomic compare-and-swap.",
        },
        {
        ...
        },
        {
          ...
          desc: "Full ACID guarantees with write-ahead logging. Safe across power failures.",
        },
        {
          name: "< 64 KB Footprint",
          desc: "The full SQL + document + KV engine fits in 64 KB of flash.",
        },
        {
          name: "Wear Leveling",
          desc: "Built-in flash wear leveling extends storage lifetime on NOR and NAND flash.",
        },
      ]}
      specs={[
        {
          key: "Query Models",
          value: "SQL (SQLite-compatible), Document (JSON), Key-Value",
        },
        {
          key: "Encryption",
          value: "AES-256-GCM at rest; key derived from eBoot TPM measurement",
        },
        {
          key: "Index Structure",
          value:
            "B-tree for SQL; hash index for KV; inverted index for document full-text search",
        },
        {
          key: "Transaction Model",
        ...
        },
        {
          ...
          value: "< 64 KB flash (SQL + document + KV)",
        },
        {
          key: "Max Database Size",
          value: "Limited by storage medium; tested to 32 GB",
        },
        {
          key: "Supported Storage",
          value: "NOR flash, NAND flash, eMMC, SD card, RAM (volatile)",
        },
      ...
      pairs={[
        {
          name: "EoS Kernel",
          route: "/product-eos",
          desc: "eDB runs as an EoS service task with direct flash HAL access.",
        },
        {
          name: "eBootloader",
          route: "/product-eboot",
          desc: "Derives AES-256 encryption keys from the eBoot TPM measurement chain.",
        },
        {
          name: "eAI",
          route: "/product-eai",
