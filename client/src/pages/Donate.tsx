        ...
        <div className="relative container mx-auto px-4 text-center max-w-3xl">
          <div className="flex items-center justify-center gap-3 mb-6">
            <Badge className="bg-orange-500/20 text-orange-300 border-orange-500/30 px-3 py-1">
              <Heart className="w-3.5 h-3.5 mr-1.5 fill-current" />501(c)(3) Nonprofit
            </Badge>
          ...
          <p className="text-sm text-white/40">Embedded Operating Systems Research Foundation · EIN: 41-4821627 · 501(c)(3) Public Charity</p>
        </div>
      </section>
              ...
              <Card className="rounded-2xl border border-white/10 bg-white/5">
                <CardContent className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { icon: Award,       label: "501(c)(3)",       sub: "Tax-exempt nonprofit" },
