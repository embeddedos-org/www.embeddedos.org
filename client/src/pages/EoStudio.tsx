...
const editors = [
  {
    ...
    color: "#F97316",
    name: "Code Editor",
    desc: "Monaco-based editor with EoS-aware syntax highlighting, auto-complete for all 197 EoS APIs, and inline documentation.",
  },
  {
    id: "flow",
    icon: Zap,
    color: "#22D3EE",
    name: "eFlow Visual Editor",
    desc: "Drag-and-drop block programming for GPIO, timers, UART, SPI, I²C, PWM, ADC, and AI inference blocks.",
  },
  {
    id: "debug",
    icon: Terminal,
    color: "#A855F7",
    name: "Debugger",
    desc: "GDB-based debugger with EoS-aware task and memory views. Set breakpoints in EoS kernel code and user tasks simultaneously.",
  },
  {
    id: "sim",
    icon: Cpu,
  ...
  },
  {
    ...
    color: "#F472B6",
    name: "AI Tutor",
    desc: "Built-in AI assistant trained on EoS documentation. Ask questions, get code examples, and debug errors in natural language.",
  },
  {
    id: "learn",
    icon: BookOpen,
    color: "#FBBF24",
    name: "Learning Paths",
    desc: "4 structured learning paths from beginner to advanced. Interactive exercises with instant feedback in the simulator.",
  },
];
...
const paths = [
  ...
  },
  {
    ...
    hours: "20h",
    color: "#22D3EE",
    topics: ["Kernel Internals", "Device Drivers", "Filesystem", "Networking"],
  },
  {
    level: "Advanced",
    title: "Security & AI",
    ...
    hours: "18h",
    color: "#A855F7",
    topics: ["Secure Boot", "Crypto APIs", "EAI Inference", "ENI Integration"],
  },
  {
    level: "Expert",
    ...
    hours: "16h",
    color: "#F97316",
    topics: ["MISRA C", "Formal Verification", "DO-178C", "IEC 61508"],
  },
];
    ...
    <div className="min-h-screen bg-[#0A0E1A] text-white">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-2xl text-gray-300 mb-2">
              The Embedded IDE for EmbeddedOS
            </p>
            <p className="text-gray-400 max-w-2xl mx-auto">
              12 specialized editors, 4 learning paths, AI tutor, and built-in
              EoSim integration — everything you need to build EoS applications
              in one environment.
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-8">
            Each editor is purpose-built for a specific aspect of embedded
            development.
          </p>
            ...
            >
              <div className="flex items-start gap-4">
                <div
                  ...
                  style={{ background: editor.color + "20" }}
                >
                  <editor.icon
                    className="w-6 h-6"
      ...
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-8">
            Structured curriculum from beginner to safety-critical expert.
            Interactive exercises with instant feedback in EoSim.
          </p>
      ...
      <section className="py-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-6">
            EoStudio is free and open-source. Download it or use the web version
            to start building EoS applications today.
          </p>
