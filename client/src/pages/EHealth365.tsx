    ...
    <div className="rounded-2xl border border-white/10 bg-[#0D1117] p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-lg font-black font-mono" style={{ color }}>
          {value}
          <span className="text-xs font-normal text-white/30 ml-1">{unit}</span>
        </span>
      </div>
      <svg
        width="100%"
...
const COVERAGE = [
  ...
  {
    metric: "Sleep stages (REM/Deep/Light)",
    device: "ring",
    method: "Accel + HRV",
    schedule: "Nightly",
  },
  {
    metric: "Steps & activity",
    device: "ring",
  ...
  },
  {
    metric: "Ketones",
    device: "ring",
    method: "Micro breath port",
    schedule: "2× daily",
  },
  {
    metric: "Blood glucose",
    device: "patch",
    method: "CGM micro-sensor",
    schedule: "Every 15 min",
  },
  {
    metric: "Sodium, potassium",
    device: "patch",
    method: "Sweat biosensor",
    schedule: "Every 4 hrs",
  },
  {
    metric: "Magnesium, zinc",
    device: "patch",
    method: "Sweat biosensor",
    schedule: "Every 4 hrs",
  },
  ...
  },
  {
    ...
    device: "patch",
    method: "Sweat sensor",
    schedule: "During exercise",
  },
  {
    metric: "Vitamins A,C,D,E,K,B1–B12",
    device: "patch",
    method: "Monthly blood cartridge",
    schedule: "Monthly",
  },
  {
    metric: "Iron, zinc, calcium, magnesium",
    device: "patch",
    method: "Monthly mineral cartridge",
    schedule: "Monthly",
  },
  {
    metric: "Calories in (nutrition)",
    device: "app",
    method: "AI food camera",
    schedule: "Per meal",
  },
];
...
export default function EHealth365() {
  const [activeDevice, setActiveDevice] = useState<"ring" | "patch" | "app">(
    "ring"
  );

  const WAVES = {
    hr: [
      50, 52, 55, 70, 90, 65, 55, 52, 50, 52, 55, 70, 90, 65, 55, 52, 50, 52,
      55, 70,
    ],
    spo2: [
      85, 86, 87, 88, 88, 87, 88, 89, 90, 89, 88, 88, 87, 88, 89, 90, 89, 88,
      88, 87,
    ],
    glucose: [
      55, 57, 60, 63, 65, 67, 68, 67, 65, 63, 61, 60, 59, 60, 62, 64, 65, 64,
      63, 62,
    ],
    temp: [
      70, 71, 71, 72, 72, 73, 73, 72, 72, 71, 71, 72, 72, 73, 73, 72, 71, 71,
      72, 72,
    ],
  };
    ...
    <div className="min-h-screen bg-[#0A0E1A] text-white">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 30% 50%, #F97316 0%, transparent 50%), radial-gradient(circle at 70% 50%, #A78BFA 0%, transparent 50%)",
          }}
        />
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                <span className="px-3 py-1 rounded-full text-xs font-bold bg-[#F97316]/10 text-[#F97316] border border-[#F97316]/20 uppercase tracking-widest">
                  eCAD Hardware
                </span>
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/embeddedos-org/eCAD-Hardware-Products/tree/master/eHealth365_CAD_Design"
                  target="_blank"
              ...
              {(["ring", "patch", "app"] as const).map(d => (
                <button
                  ...
                  style={{
                    ...
                    color:
                      activeDevice === d ? "#fff" : "rgba(255,255,255,0.4)",
                  }}
                >
                  {d === "ring"
                    ? "💍 Smart Ring Pro"
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <AnimatePresence mode="wait">
                  {COVERAGE.filter(r => r.device === activeDevice).map(
                    (row, i) => (
                      <motion.tr
                        key={row.metric}
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-white/5 text-white/40">
                            {row.schedule}
                          </span>
                        </td>
                      </motion.tr>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                <div className="text-2xl font-black text-[#F97316] mb-1">
                  {p.price}
                </div>
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-white/50 mb-8">
              Full KiCad schematics, flex PCB layouts, BOM, 3D models, and app
