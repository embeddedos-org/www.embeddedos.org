...
const APPS = [
  {
    ...
    preview: {
      ...
      content: [
        ...
        {
          type: "p",
          text: "This document summarises the key findings from the third quarter...",
        },
        {
          type: "p",
  ...
  },
  {
    ...
    preview: {
      ...
      content: [
        ...
        {
          type: "code",
          text: "$ ebuild flash --board stm32h7 --image eboot.bin",
        },
  ...
  },
  {
    ...
    preview: {
      ...
      content: [
        ...
        {
          type: "bullet",
          text: "Layer 2: Components (STM32H7, caps, resistors)",
        },
  ...
  },
  {
    ...
    preview: {
      ...
      content: [
        ...
        {
          type: "row",
          text: "Bob Kumar — bob@embeddedos.org · Core Contributor",
        },
        {
          type: "row",
          text: "Carol Diaz — carol@embeddedos.org · Health Team",
        },
        {
          type: "p",
          text: "Groups: TSC (7) · Contributors (42) · Health (12)",
        },
      ],
    },
  },
  {
    ...
    preview: {
      ...
      content: [
        ...
        {
          type: "row",
          text: "  HEALTH-KEY ULTRA PCB rev3 shipped — Bob Kumar",
        },
    ...
    <div className="min-h-screen bg-[#080F1E]">
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            A complete office productivity suite built for embedded displays,
            workstations, and mobile devices. Word processor, spreadsheet,
            slides, notes, drawing, calendar, contacts, email, chat, and file
            manager — all running natively on EmbeddedOS.
          </motion.p>
          ...
          >
            {[
              ...
              return (
                <span
                  key={p.label}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm text-white/60"
                  style={{
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-white/40 text-base">
              Click any app to see what it does
            </p>
          </motion.div>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        activeApp === a.id ? `${a.color}25` : `${a.color}12`,
                    }}
                  >
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm" style={{ color: app.color }}>
                      {app.subtitle}
                    </p>
                  </div>
                </div>
                      ...
                      style={{
                        color:
                          item.type === "h1"
                            ...
                            : item.type === "header"
                              ? app.color
                              : item.type === "formula" || item.type === "code"
                                ? "#34D399"
                                : item.type === "note"
                                  ? "#F59E0B"
                                  : item.type === "bullet"
                        ...
                        fontFamily:
                          item.type === "code" || item.type === "formula"
                            ? "monospace"
                            : undefined,
                        fontWeight:
                          item.type === "h1" || item.type === "header"
                            ? "700"
                            : undefined,
                        paddingLeft:
                          item.type === "bullet" ? "1rem" : undefined,
                      }}
                    >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-white/55 text-lg mb-6 max-w-xl mx-auto">
              eOffice is part of the eApps ecosystem. Install it on any EoS
