...
import { Heart, Github, Globe, BookOpen, Cpu, Users, ArrowRight, Mail, Linkedin, Youtube, Twitter, Facebook } from "lucide-react";
...
const MILESTONES = [
  { year: "2018", title: "Project Inception", desc: "embeddedos.org domain registered and the EmbeddedOS project started — early research into a unified open-source OS for every embedded device." },
  { year: "2020", title: "Kernel Architecture Research", desc: "Core kernel architecture and real-time scheduling research underway, targeting ARM Cortex-M and RISC-V platforms." },
  { year: "2023", title: "EoS Kernel v0.1", desc: "First public release of the EoS real-time kernel, supporting ARM Cortex-M and RISC-V architectures." },
...
export default function About() {
  return (
    <div className="min-h-screen pt-16">
      ...
      <section className="section-padding bg-grid relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <motion.div variants={fadeUp} initial="hidden" animate="visible">
            <div className="badge-amber mb-4 inline-flex">About the Foundation</div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <p className="text-white/60 leading-relaxed mb-4">
                The Embedded Operating Systems Research Foundation was established to create a world where
                every embedded device — from a $2 microcontroller to a VTOL aircraft — runs on open,
                auditable, and community-maintained software.
              </p>
              <p className="text-white/60 leading-relaxed mb-4">
                We believe that the software powering medical devices, industrial controllers, aerospace
                avionics, and consumer electronics should be transparent, secure, and accessible to
            ...
            >
              {[
                ...
                { value: "52+", label: "Supported Platforms", color: "#22D3EE" },
                ...
                <div key={s.label} className="glass rounded-xl p-4 border border-white/5 text-center">
                  <div className="font-heading font-extrabold text-2xl mb-1" style={{ color: s.color }}>{s.value}</div>
      ...
      <section className="section-padding bg-[#080F1E]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-10">
            ...
            <h2 className="font-heading font-bold text-white text-3xl">What We Stand For</h2>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-10">
            ...
            <h2 className="font-heading font-bold text-white text-3xl">Our Journey</h2>
          </motion.div>
              ...
              {MILESTONES.map((m, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-[#F97316]/20 border border-[#F97316]/40 flex items-center justify-center shrink-0 z-10">
                    <span className="text-[10px] font-bold text-[#F97316]">{m.year}</span>
                  </div>
                  <div className="glass rounded-xl p-4 border border-white/5 flex-1">
                    <div className="font-semibold text-white mb-1">{m.title}</div>
                    <div className="text-sm text-white/50 leading-relaxed">{m.desc}</div>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="section-padding bg-[#080F1E]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="glass rounded-2xl border border-white/10 p-8">
            <div className="badge-teal mb-4 inline-flex">Legal & Governance</div>
            <h2 className="font-heading font-bold text-white text-2xl mb-4">Foundation Details</h2>
            <div className="grid sm:grid-cols-2 gap-6 text-sm">
              <div>
                <div className="text-white/40 text-xs uppercase tracking-widest mb-1">Legal Name</div>
                <div className="text-white">Embedded Operating Systems Research Foundation</div>
              </div>
              <div>
              ...
              <div>
                <div className="text-white/40 text-xs uppercase tracking-widest mb-1">Hosting</div>
                <div className="text-white">Powered by InterServer</div>
              </div>
              <div>
                <div className="text-white/40 text-xs uppercase tracking-widest mb-1">Website</div>
                <div className="text-white">
                  <a href="https://www.embeddedos.org" target="_blank" rel="noopener noreferrer" className="text-[#F97316] hover:underline">www.embeddedos.org</a>
                </div>
              </div>
              <div>
                <div className="text-white/40 text-xs uppercase tracking-widest mb-1">Contact</div>
                <div className="text-white">
                  <a href="mailto:hello@embeddedos.org" className="text-[#F97316] hover:underline">hello@embeddedos.org</a>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h2 className="font-heading font-bold text-white text-2xl mb-2">Connect With Us</h2>
            <p className="text-white/50 text-sm mb-6">Follow the foundation across all platforms for updates, research, and community news.</p>
            <div className="flex justify-center flex-wrap gap-3">
              {[
                { icon: Github, href: "https://github.com/embeddedos-org", label: "GitHub", color: "#F97316" },
                { icon: Twitter, href: "https://x.com/EmbeddedOS_ORG", label: "X / Twitter", color: "#22D3EE" },
                { icon: Linkedin, href: "https://www.linkedin.com/company/embedded-operating-systems-research-foundation", label: "LinkedIn", color: "#60A5FA" },
                { icon: Youtube, href: "https://www.youtube.com/@EmbeddedOS_ORG", label: "YouTube", color: "#F85149" },
                { icon: Facebook, href: "https://www.facebook.com/profile.php?id=61588978691494", label: "Facebook", color: "#A78BFA" },
                { icon: Mail, href: "mailto:hello@embeddedos.org", label: "Email", color: "#34D399" },
