  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: Activity,
        label: "ENI / Neural",
        sub: "Configurable neural research · spike sorting",
        href: "/eni",
      },
      {
        icon: Database,
...
const USE_CASES = [
  ...
  },
  {
    ...
    desc: "eRadar360 Aegis One is a design-stage reference architecture for radar, camera, and V2X fusion on EoS. Detection performance, CAN partitioning, and the NXP S32K344 build remain implementation and validation targets.",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                title: "EAI + ENI",
                sub: "Intelligence",
                desc: "On-device AI and configurable neural-interface research for BCI, sEMG, and EEG applications. Model and acquisition limits depend on the named hardware configuration.",
                href: "/eai",
                cta: "Explore EAI",
              },
              {
