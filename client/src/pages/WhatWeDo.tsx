...
import {
  Cpu, Zap, Brain, Network, Database, Package, Monitor, Globe, Smartphone,
  Layers, Shield, Activity, Code2, HardDrive, Wifi, ChevronRight, ArrowRight,
  Rocket, Factory, Heart, Car, Plane, Bot, Building2, Leaf, Microscope
} from "lucide-react";
...
const STACK_LAYERS = [
  {
    ...
    items: [
      { icon: Heart, label: "Health Devices", sub: "KEY, BAND, RING, LAB", href: "/health" },
      { icon: Plane, label: "Aerospace", sub: "AeroSwift, ePAM", href: "/aerospace" },
      { icon: Car, label: "Transport", sub: "eRadar360, ADAS", href: "/eradar360" },
      { icon: Factory, label: "Industrial", sub: "PLCs, Sensors, HMI", href: "/ecad-hardware" },
      { icon: Bot, label: "Robotics", sub: "Arms, AMR, Cobots", href: "/ecad-hardware" },
      { icon: Leaf, label: "Energy", sub: "BMS, Solar, Grid", href: "/ecad-hardware" },
    ],
  },
  {
    id: "os",
    ...
    items: [
      { icon: Cpu, label: "EoS Kernel", sub: "RTOS · 33 HAL peripherals · 41 profiles", href: "/eos" },
      { icon: Shield, label: "eBoot", sub: "Secure bootloader · A/B slots · Ed25519", href: "/eboot" },
      { icon: Package, label: "eBuild", sub: "Cross-compile · 18 commands · 14 SDKs", href: "/ebuild" },
      { icon: Network, label: "EIPC", sub: "Secure IPC · HMAC-SHA256 · zero-copy", href: "/eipc" },
    ],
  },
  {
    id: "intelligence",
    ...
    items: [
      { icon: Brain, label: "EAI Runtime", sub: "On-device LLM · ReAct agents · LoRA", href: "/eai" },
      { icon: Activity, label: "ENI / Neural", sub: "1,024-ch BCI · spike sorting · TENS", href: "/eni" },
      { icon: Database, label: "eDB", sub: "SQL + Doc + KV · AES-256 · REST API", href: "/edb" },
    ],
  },
  {
    id: "applications",
    ...
    items: [
      { icon: Monitor, label: "eOffice Suite", sub: "11 productivity apps · CRDT collab", href: "/eoffice" },
      { icon: Layers, label: "eApps (43)", sub: "Productivity · Media · Games · Connectivity", href: "/eapps" },
      { icon: Globe, label: "eBrowser", sub: "Embedded web engine · DOM API · JS", href: "/ebrowser" },
      { icon: Smartphone, label: "eServiceApps", sub: "Flutter super-app · eSocial · eRide", href: "/eserviceapps" },
    ],
  },
  {
    id: "tools",
    ...
    items: [
      { icon: Code2, label: "EoStudio IDE", sub: "Board picker · HAL config · AI tutor", href: "/eostudio" },
      { icon: HardDrive, label: "EoSim", sub: "52+ virtual platforms · QEMU · HIL", href: "/eosim" },
      { icon: Wifi, label: "eFlow", sub: "Visual node editor · 5 block categories", href: "/eflow" },
    ],
  },
];
      ...
      <div className="space-y-3">
        {STACK_LAYERS.map((layer, li) => (
          <motion.div
            ...
            transition={{ delay: li * 0.12, duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
            ...
            style={{
              ...
              borderColor: activeLayer === layer.id ? layer.border : "rgba(255,255,255,0.08)",
            }}
          >
...
function UseCaseCard({ uc, index }: { uc: typeof USE_CASES[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay: (index % 4) * 0.08, duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="font-bold text-white text-lg leading-tight">{uc.title}</h3>
        </div>
      </div>
      <p className="text-gray-400 text-sm leading-relaxed">{uc.desc}</p>
      <div className="flex flex-wrap gap-2 mt-auto">
        {uc.products.map((p) => (
          <span key={p} className="text-[11px] font-mono px-2 py-0.5 rounded-full"
      ...
      <Link href={uc.href}>
        <div className="flex items-center gap-1 text-xs font-semibold mt-1 opacity-0 group-hover:opacity-100 transition-opacity"
  ...
  return (
    <div className="min-h-screen bg-[#050A14] text-white">
      ...
      <section ref={heroRef} className="relative pt-28 pb-20 px-6 overflow-hidden">
        <img src="/images/what-we-do-illustration_4c2ad2f7.png" alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover opacity-8 pointer-events-none" />
        {/* Background grid */}
        ...
        <div className="absolute top-40 right-1/4 w-80 h-80 rounded-full blur-3xl opacity-10"
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed mb-10">
              We build the complete software stack for intelligent embedded devices — from the bare-metal kernel
              to AI inference, neural interfaces, productivity apps, and developer tools. One open-source
              foundation powering every device category.
            </p>
      ...
      <section className="border-y py-8 px-6" style={{ borderColor: "rgba(255,255,255,0.07)", background: "rgba(255,255,255,0.02)" }}>
        <div className="max-w-5xl mx-auto grid grid-cols-3 md:grid-cols-6 gap-6">
          {PRODUCT_NUMBERS.map((n, i) => (
            ...
            >
              <div className="text-3xl font-black" style={{ color: ["#22D3EE","#34D399","#A78BFA","#F97316","#FBBF24","#F472B6"][i] }}>
                {n.value}
              </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black mb-4">The Complete Embedded Stack</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Every layer is open-source, MIT-licensed, and designed to work together — or independently.
              Hover a layer to explore. Click any product to learn more.
            </p>
          </div>
      ...
      <section className="py-20 px-6" style={{ background: "rgba(255,255,255,0.01)" }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black mb-4">What We Build</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Five product families that compose into any embedded system — from a 32 KB microcontroller
              to a quad-core application processor.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: Cpu, color: "#22D3EE", title: "EoS + eBoot", sub: "OS Foundation",
                ...
                href: "/eos", cta: "Explore EoS",
              },
              {
                icon: Brain, color: "#A78BFA", title: "EAI + ENI", sub: "Intelligence",
                ...
                href: "/eai", cta: "Explore EAI",
              },
              {
                icon: Network, color: "#34D399", title: "EIPC + eDB", sub: "Data & Comms",
                ...
                href: "/eipc", cta: "Explore EIPC",
              },
              {
                icon: Monitor, color: "#F97316", title: "eOffice + eApps", sub: "Applications",
                ...
                href: "/eoffice", cta: "Explore eOffice",
              },
              {
                icon: Code2, color: "#FBBF24", title: "EoStudio + EoSim", sub: "Developer Tools",
                ...
                href: "/eostudio", cta: "Explore EoStudio",
              },
              {
                icon: Package, color: "#F472B6", title: "eBuild + eFlow", sub: "Build System",
                ...
                href: "/ebuild", cta: "Explore eBuild",
              },
            ].map((card, i) => (
              <motion.div
                key={card.title}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs" style={{ color: card.color }}>{card.sub}</div>
                  </div>
                </div>
                <p className="text-gray-400 text-sm leading-relaxed flex-1">{card.desc}</p>
                <Link href={card.href}>
                  <div className="flex items-center gap-1 text-sm font-semibold transition-opacity"
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black mb-4">Industry Use Cases</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              EmbeddedOS products compose into complete solutions across eight major device categories.
            </p>
          </div>
      ...
      <section className="py-20 px-6" style={{ background: "rgba(255,255,255,0.01)" }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black mb-4">Hardware Design Portfolio</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              15 CAD hardware design categories — from health wearables to aerospace systems —
              all engineered to run the EmbeddedOS stack.
            </p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { icon: Heart, color: "#EF4444", label: "Health", sub: "4 wearables", href: "/health" },
              { icon: Plane, color: "#22D3EE", label: "Aerospace", sub: "Aircraft, UAV, Space", href: "/aerospace" },
              { icon: Car, color: "#F97316", label: "Transport", sub: "ADAS, Rail, Maritime", href: "/eradar360" },
              { icon: Bot, color: "#A78BFA", label: "Robotics", sub: "Arms, AMR, Cobots", href: "/ecad-hardware" },
              { icon: Factory, color: "#34D399", label: "Industrial", sub: "PLCs, Sensors, HMI", href: "/ecad-hardware" },
              { icon: Leaf, color: "#10B981", label: "Energy", sub: "BMS, Solar, Grid", href: "/ecad-hardware" },
              { icon: Building2, color: "#60A5FA", label: "Smart City", sub: "Traffic, Utilities, 5G", href: "/ecad-hardware" },
              { icon: Microscope, color: "#F59E0B", label: "Medical", sub: "ECG, EEG, Surgical", href: "/ecad-hardware" },
              { icon: Rocket, color: "#F472B6", label: "ePAM", sub: "eVTOL, Space, EcoCar", href: "/aerospace" },
              { icon: Shield, color: "#6366F1", label: "Defense", sub: "Surveillance, Tactical", href: "/ecad-hardware" },
              { icon: Wifi, color: "#06B6D4", label: "Consumer", sub: "Smart home, AR, Wearables", href: "/ecad-hardware" },
              { icon: Zap, color: "#FBBF24", label: "Electronics", sub: "PCBs, FPGAs, AI chips", href: "/ecad-hardware" },
              { icon: Brain, color: "#8B5CF6", label: "Mining", sub: "Autonomous, Safety", href: "/ecad-hardware" },
              { icon: Globe, color: "#14B8A6", label: "Cybersecurity", sub: "HSMs, Firewalls, Access", href: "/ecad-hardware" },
              { icon: HardDrive, color: "#F87171", label: "Future Designs", sub: "10 concept products", href: "/ecad-hardware" },
            ].map((item, i) => (
              <Link key={item.label} href={item.href}>
                <motion.div
