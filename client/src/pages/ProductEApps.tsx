...
export default function ProductEApps() {
  return (
    <ProductDetailPage
      ...
      heroImage="/manus-storage/product-eapps_45231c91.jpg"
      ...
      usageExamples={[
        {
          ...
          scenario: "A Raspberry Pi 4 running EoS as a smart home hub with eWeather, eHome, and eEnergy apps.",
      ...
      features={[
        { name: "60+ First-Party Apps", desc: "Productivity, developer tools, system utilities, health, entertainment, and IoT apps." },
        { name: "Package Manager", desc: "CLI and GUI package manager with dependency resolution, version pinning, and rollback." },
        { name: "Signed Packages", desc: "All packages are Ed25519 signed. eBoot verifies signatures before installation." },
        { name: "App Store", desc: "Web-based app store at apps.embeddedos.org with search, ratings, and reviews." },
        { name: "EIPC Integration", desc: "Apps communicate via EIPC — launch, share data, and integrate with system services." },
        { name: "< 1 MB Typical Size", desc: "Apps are optimized for embedded storage — most apps fit in under 1 MB." },
        { name: "Auto-Update", desc: "Background app updates with A/B slot mechanism — no downtime." },
        { name: "Sandboxing", desc: "Each app runs in an EoS process with capability-limited access to system resources." },
      ]}
      specs={[
        { key: "First-Party Apps", value: "60+ across productivity, developer tools, utilities, health, entertainment" },
        { key: "Package Format", value: ".eapp (signed ZIP with manifest, binary, and assets)" },
        { key: "Signature Algorithm", value: "Ed25519" },
        { key: "Package Manager", value: "eApps CLI + EoStudio App Browser" },
        { key: "Registry", value: "apps.embeddedos.org (public, open submission)" },
        { key: "Typical App Size", value: "< 1 MB (binary + assets)" },
        { key: "License", value: "MIT (all first-party apps)" },
      ]}
      pairs={[
        { name: "eOffice Suite", route: "/product-eoffice", desc: "The flagship eApps bundle — 11 productivity apps for embedded devices." },
        { name: "eBuild", route: "/product-ebuild", desc: "Build and package EoS apps with eBuild's eapp target." },
        { name: "EIPC", route: "/product-eipc", desc: "All eApps communicate with each other and system services via EIPC." },
      ]}
    />
  );
}
