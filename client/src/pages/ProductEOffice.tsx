...
export default function ProductEOffice() {
  return (
    <ProductDetailPage
      badge="Office Suite"
      title="eOffice Suite — 11-App Embedded Office Suite"
      subtitle="eWrite · eCalc · ePresent · eNotes · eMail · eCalendar · eCam · eFiles · eContacts · eChat · eVault"
      description="A complete 11-application office suite designed to run natively on EoS devices — from a Raspberry Pi to an automotive infotainment system. All apps share a unified eDB storage backend, EIPC inter-app communication, and a consistent UI framework optimized for embedded displays."
      accent="#059669"
      gradient="from-emerald-500/20 to-green-600/20"
      lang="C++ / eUI"
      github="embeddedos-org/eoffice"
      heroImage="/manus-storage/product-eoffice-suite_d63eacf5.png"
      stackHighlight="app layer"
      stats={[
        { value: "11", label: "Applications" },
        { value: "eDB", label: "Unified Storage Backend" },
        { value: "< 32 MB", label: "Full Suite RAM" },
        { value: "EIPC", label: "Inter-App Communication" },
      ]}
      workflow={[
        {
          step: 1,
          title: "Install the eOffice Suite",
          desc: "eOffice is distributed as an .eos application package. Install it via the eApps package manager or include it in your eBuild manifest. All 11 apps share a single eDB database for unified storage.",
          code: "# Install via eApps\neapps install eoffice-suite\n\n# Or include in manifest.yml\npackages:\n  - eoffice-suite: 1.0.0",
        },
        {
          step: 2,
