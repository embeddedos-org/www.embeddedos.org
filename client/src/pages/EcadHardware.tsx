  ...
  return (
    <div className="min-h-screen bg-[#050A14] text-white">
      ...
      <section className="relative pt-28 pb-16 px-6 overflow-hidden">
        <img src="/images/product-ecad-hardware_f5806032.png" alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover opacity-8 pointer-events-none" />
