        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <motion.div variants={fadeUp} initial="hidden" animate="visible">
            ...
            <h1 className="font-heading font-extrabold text-4xl sm:text-5xl text-white mb-4">
              Choose Your <span className="text-gradient">Stack</span>
            </h1>
            <p className="text-white/60 text-lg max-w-2xl mx-auto mb-8">
              EmbeddedOS is modular. Use only what you need — from a 4 KB
              bare-metal kernel to a full application platform with AI,
