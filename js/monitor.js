/**
 * EmbeddedOS — Error Monitoring & Performance Tracking
 *
 * Setup:
 *   1. Create a Sentry account at https://sentry.io
 *   2. Create a new Browser JavaScript project
 *   3. Copy the DSN URL
 *   4. Set it as a GitHub variable: gh variable set SENTRY_DSN --body "https://xxx@xxx.ingest.sentry.io/xxx"
 *   5. Or set window.__SENTRY_DSN__ before this script loads
 *
 * This script provides:
 *   - Sentry integration (when DSN is configured)
 *   - Lightweight fallback error logging (always active)
...
(function () {
  ...
  // --- Lightweight Error Log (always active) ---
  var errorLog = [];
  ...
  function initSentry() {
    ...
    script.onload = function () {
      ...
      // Replay any errors captured before Sentry loaded
