import{j as e}from"./vendor-motion-DJ7isXre.js";import{P as t}from"./ProductDetailPage-xo_ajyXE.js";import"./vendor-react-r7gXz3yt.js";import"./index-ctpMHat3.js";import"./code-xml-BmF5Lmxx.js";import"./circle-check-BQYC95N1.js";function i(){return e.jsx(t,{badge:"Database",title:"eDB — Embedded Multi-Model Database",subtitle:"SQL · Document · Key-Value · AES-256 · < 1 ms Query",description:"A multi-model embedded database for EoS devices. Supports SQL, document (JSON), and key-value stores in a single engine — with AES-256 at-rest encryption rooted in the eBoot chain of trust, < 1 ms query latency, and a < 64 KB footprint.",accent:"#3B82F6",gradient:"from-blue-500/20 to-indigo-600/20",lang:"C",github:"embeddedos-org/edb",heroImage:"/manus-storage/product-edb_9cd0fe0e.jpg",stackHighlight:"data layer",stats:[{value:"3",label:"Query Models (SQL, Doc, KV)"},{value:"< 1 ms",label:"Query Latency"},{value:"AES-256",label:"At-Rest Encryption"},{value:"< 64 KB",label:"Engine Footprint"}],workflow:[{step:1,title:"Open a Database",desc:"eDB databases are single-file stores on flash or SD card. Open with edb_open(), passing the encryption key derived from the eBoot chain of trust. eDB automatically creates the file if it doesn't exist.",code:`// Open encrypted eDB database
#include <edb/edb.h>
