import{j as e,m as i}from"./vendor-motion-D7Nov3QW.js";import"./vendor-react-DdUyh3Gc.js";const o={hidden:{opacity:0,y:20},visible:(t=0)=>({opacity:1,y:0,transition:{duration:.4,delay:t*.05,ease:"easeOut"}})},r=[{title:"1. Information We Collect",content:`We collect minimal information necessary to operate this website. This includes:
...
We do not sell, rent, or share your personal information with third parties for marketing purposes.`},{title:"3. Cookies",content:`This website uses only essential cookies required for basic functionality (session management). We do not use advertising, analytics, or cross-site tracking cookies.
...
We have no control over the data practices of these third parties.`},{title:"5. Data Retention",content:"We retain contact inquiry emails for up to 12 months. Hosting logs are retained according to InterServer's operational policies. Retention of donation records depends on Zeffy's practices and the Foundation's applicable accounting and legal obligations."},{title:"6. Your Rights",content:`You have the right to:
...
To exercise these rights, contact us through the form at www.embeddedos.org/contact.`},{title:"7. Children's Privacy",content:"This website is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe we have inadvertently collected such information, please contact us immediately through the form at www.embeddedos.org/contact."},{title:"8. Changes to This Policy",content:"We may update this Privacy Policy from time to time. Changes will be posted on this page with an updated effective date. Continued use of the website after changes constitutes acceptance of the updated policy."},{title:"9. Contact",content:`For privacy-related questions or requests, contact the Embedded Operating Systems Research Foundation at:

**Contact form:** www.embeddedos.org/contact
**Website:** www.embeddedos.org
**GitHub:** github.com/embeddedos-org`}];function l(){return e.jsxs("div",{className:"min-h-screen pt-16",children:[e.jsxs("section",{className:"section-padding bg-grid relative overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-[#0B1D3A]/80 to-[#080F1E]"}),e.jsx("div",{className:"relative max-w-3xl mx-auto px-4 sm:px-6 text-center",children:e.jsxs(i.div,{variants:o,initial:"hidden",animate:"visible",children:[e.jsx("div",{className:"badge-teal mb-4 inline-flex",children:"Legal"}),e.jsx("h1",{className:"font-heading font-extrabold text-4xl text-white mb-4",children:"Privacy Policy"}),e.jsx("p",{className:"text-white/50 text-sm",children:"Effective date: September 15, 2026 · Embedded Operating Systems Research Foundation"})]})})]}),e.jsx("section",{className:"section-padding",children:e.jsxs("div",{className:"max-w-3xl mx-auto px-4 sm:px-6",children:[e.jsx(i.div,{variants:o,initial:"hidden",whileInView:"visible",viewport:{once:!0},className:"glass rounded-2xl border border-white/10 p-6 sm:p-8 mb-6",children:e.jsxs("p",{className:"text-white/60 text-sm leading-relaxed",children:['The Embedded Operating Systems Research Foundation ("Foundation", "we", "us", or "our") operates the website at'," ",e.jsx("strong",{className:"text-white",children:"www.embeddedos.org"}),". This Privacy Policy explains how we collect, use, and protect information when you use our website, documentation, and services. As a 501(c)(3), we are committed to transparency and minimal data collection."]})}),e.jsx("div",{className:"space-y-6",children:r.map((t,s)=>e.jsxs(i.div,{variants:o,initial:"hidden",whileInView:"visible",viewport:{once:!0},custom:s,className:"glass rounded-xl border border-white/5 p-6",children:[e.jsx("h2",{className:"font-heading font-bold text-white text-lg mb-3",children:t.title}),e.jsx("div",{className:"text-white/60 text-sm leading-relaxed whitespace-pre-line",children:t.content.split("**").map((a,n)=>n%2===1?e.jsx("strong",{className:"text-white",children:a},n):a)})]},t.title))})]})})]})}export{l as default};
