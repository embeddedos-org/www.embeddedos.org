import{j as e}from"./vendor-motion-DJ7isXre.js";import{P as t}from"./ProductDetailPage-BcTikXNV.js";import"./vendor-react-r7gXz3yt.js";import"./index-DojdTcmd.js";import"./code-xml-C9Mgvlif.js";import"./circle-check-CBo23BMP.js";function d(){return e.jsx(t,{badge:"Bootloader",title:"eBootloader — Multi-Architecture Bootloader",subtitle:"10 Architectures · 24 Reference Boards · A/B Update Slots",description:"A portable, secure, fail-safe bootloader for 24 boards across 10 architectures. Supports A/B update slots, measured boot, TPM 2.0, and a unified board-support package model.",accent:"#F97316",gradient:"from-orange-500/20 to-red-600/20",lang:"C",github:"embeddedos-org/eboot",heroImage:"/manus-storage/product-eboot_90e7936e.jpg",stackHighlight:"ebootloader",stats:[{value:"10",label:"Architectures"},{value:"24",label:"Reference Boards"},{value:"A/B",label:"Update Slots"},{value:"< 500 ms",label:"Cold Boot (Cortex-M)"}],workflow:[{step:1,title:"ROM Bootstrap",desc:"The chip's immutable ROM code runs first. It reads the eBoot primary image from flash, verifies its Ed25519 signature against the public key burned into OTP, and jumps to eBoot if the signature is valid.",code:`# ROM verifies eBoot signature against OTP public key
