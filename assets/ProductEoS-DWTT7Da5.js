...
}`},{title:"Industrial Motor Controller",scenario:"Illustrative motor-control configuration using a 20 kHz PWM loop; timing and jitter require target-specific measurement.",code:`// EoS real-time motor control (FOC at 20 kHz)
#include <eos/kernel.h>
