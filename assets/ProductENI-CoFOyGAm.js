...
}`}],usageExamples:[{title:"Motor BCI Prosthetic",scenario:"Decoding 64-channel ECoG signals to control a robotic arm with < 10 ms end-to-end latency.",code:`// Motor BCI pipeline: ECoG → eNI → EIPC → eAI → arm
#include <eni/eni.h>
#include <eai/model.h>
#include <eipc/eipc.h>
