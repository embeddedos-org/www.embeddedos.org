import{j as e}from"./vendor-react-aOLDZyDv.js";import{P as n}from"./ProductDetailPage-Bkyptzcl.js";import"./ecosystem-Cbq53__1.js";import"./index-DQH62YFQ.js";import"./vendor-motion-Q4tZCRqk.js";import"./code-xml-CI1DIRs8.js";import"./circle-check-Bm92lWON.js";function c(){return e.jsx(n,{badge:"Neural Interface",title:"eNI — Neural Interface Platform",subtitle:"Configurable Channels · Hardware-Defined Sample Rates · Neural Research",description:"An in-development neural signal acquisition and processing platform for EEG, EMG, ECoG, LFP, and spike-train research. Channel count and sample rate depend on the acquisition hardware and configuration; performance limits remain research targets until measured on a named setup.",accent:"#10B981",gradient:"from-emerald-500/20 to-green-600/20",lang:"C / VHDL",github:"embeddedos-org/eNI",heroImage:"/media/product-eni-neural_0723fbf2.jpg",stackHighlight:"neural interface",stats:[{value:"Configurable",label:"Channel Map"},{value:"Hardware",label:"Sample-Rate Limit"},{value:"Research",label:"Spike-Sorting Pipeline"},{value:"Front End",label:"ADC Resolution"}],workflow:[{step:1,title:"Configure the Acquisition Pipeline",desc:"Select the signal modality (EEG, EMG, ECoG, LFP, spikes) and configure the channel map, sample rate, and hardware filter parameters. eNI supports mixed-modality acquisition — EEG and EMG simultaneously on different channel groups.",code:`eni_config_t cfg = {
...
eni_spike_enable(eni, &sc);`},{step:4,title:"Stream Data to eAI via EIPC",desc:"eNI packages filtered signals and spike events into EIPC messages and sends them to the eAI inference task. The design uses HMAC-SHA256 integrity and AES-256 encryption; medical use would require system-level validation and regulatory approval.",code:`// eNI streams to eAI via EIPC
...
}`}],usageExamples:[{title:"Motor BCI Prosthetic",scenario:"Illustrative research configuration for evaluating ECoG motor-intent decoding with an assistive controller.",code:`// Illustrative research pipeline: ECoG → eNI → EIPC → eAI
#include <eni/eni.h>
#include <eai/model.h>
#include <eipc/eipc.h>
...
}`},{title:"Seizure Detection",scenario:"Illustrative research pipeline for evaluating EEG pattern detection; it does not claim clinical detection performance or treatment efficacy.",code:`// Seizure detection pipeline
#include <eni/eni.h>
#include <eai/model.h>
