import{r as h,j as e,L as d}from"./vendor-react-aOLDZyDv.js";import{c as j}from"./clipboard-B9HKxd0_.js";import{m as P}from"./tablist-HF54SSn-.js";import{h as n,W as A,C as c,d as f,L as y,i as w,a as m,b as C,j as _,k as N,l as T,m as O,A as I}from"./index-DgD7KEE1.js";import{m as s}from"./vendor-motion-Q4tZCRqk.js";import{P as S}from"./play-ClluMIaS.js";import{C as x}from"./circle-check-DoOU4NB8.js";import{M as v}from"./monitor-CyGge5GE.js";import{P as D}from"./pen-tool-vgXD62gP.js";import{I as B}from"./info-DtC3TtAB.js";import{C as L}from"./copy-CpH8Mkqi.js";import{H as F}from"./hard-drive-DANcP046.js";const o={hidden:{opacity:0,y:20},visible:(r=0)=>({opacity:1,y:0,transition:{duration:.45,delay:r*.07,ease:[.23,1,.32,1]}})},M=[{id:"ebuild",name:"ebuild",role:"Build Tool",desc:"Compiles, links, analyzes CAD, and flashes firmware. The single CLI for the entire EoS lifecycle.",color:"#F97316",icon:A},{id:"eosim",name:"EoSim",role:"Simulator",desc:`Runs your firmware in-browser on ${n} virtual platforms. No hardware required — ever.`,color:"#22D3EE",icon:v},{id:"eos",name:"EoS Kernel",role:"RTOS Kernel",desc:"The real-time OS kernel. Provides HAL, scheduler, IPC, drivers, and POSIX subset.",color:"#F97316",icon:c},{id:"eboot",name:"eBoot",role:"Bootloader",desc:"Secure bootloader with verified boot, OTA A/B updates, and hardware root of trust.",color:"#F59E0B",icon:f},{id:"eflow",name:"eFlow",role:"Visual Programming",desc:"Drag-and-drop block editor that generates production C code. No assembly needed for common patterns.",color:"#A78BFA",icon:y},{id:"eai",name:"EAI / ENI",role:"Edge AI",desc:"On-device TFLite/ONNX inference and neural interface adapter for BCI devices.",color:"#34D399",icon:w},{id:"eapps",name:"eApps",role:"App Ecosystem",desc:"60+ apps including eOffice Suite, eBrowser, eDB, and eBot AI assistant.",color:"#60A5FA",icon:m},{id:"eostudio",name:"EoStudio",role:"IDE",desc:"Universal IDE with AI tutor, 3D modeler, game editor, and UI designer.",color:"#F472B6",icon:C}],R=[{id:"nosim",icon:S,label:"No Hardware, No Install",sublabel:"Run in browser — 60 seconds",color:"#34D399",badge:"Fastest"},{id:"sim",icon:v,label:"Simulator on My Computer",sublabel:"Full EoSim CLI + ebuild",color:"#22D3EE"},{id:"esp32",icon:_,label:"I Have an ESP32",sublabel:"Flash EoS to $5 board",color:"#F97316"},{id:"stm32",icon:c,label:"I Have an STM32",sublabel:"Nucleo / Discovery board",color:"#22D3EE"},{id:"apps",icon:m,label:"I Want to Build eApps",sublabel:"C + LVGL cross-platform apps",color:"#F59E0B"},{id:"hardware-design",icon:D,label:"I'm a Hardware Engineer",sublabel:"CAD → ebuild → simulate → flash",color:"#A78BFA"}],g={nosim:{title:"Run EoS in Your Browser — No Install",color:"#34D399",intro:"EoSim runs entirely in your browser using WebAssembly. You can write, compile, and simulate firmware on a virtual STM32, ESP32, or Raspberry Pi Pico without installing anything. This is the fastest way to understand what EmbeddedOS is.",prereq:"A modern browser (Chrome 90+, Firefox 88+, Safari 15+). That is it.",time:"~5 minutes",steps:[{title:"Open the EoSim Demo",text:"Navigate to the EoSim demo page. You will see a virtual board with GPIO pins, a code editor, and a UART output console. No login required.",substeps:["Click 'Demo' in the top navigation, or go directly to /demo","The simulator loads a virtual STM32F4 board by default"]},{title:"Choose a Board",text:`EoSim supports ${n} virtual platforms. For your first run, keep the default STM32F4 Discovery. You can switch to ESP32 or Raspberry Pi Pico using the board selector.`,substeps:["STM32F4 — ARM Cortex-M4, 168MHz, 1MB flash","ESP32 — Xtensa LX6, 240MHz, Wi-Fi + BT","RPi Pico — RP2040, dual-core ARM Cortex-M0+"]},{title:"Select a Program",text:"Three example programs are pre-loaded:",substeps:["LED Blink — Toggles GPIO PA5 every 500ms. The simplest possible EoS program.","UART Echo — Reads from UART1 and echoes back. Demonstrates the EoS UART HAL.","GPIO Scanner — Reads all GPIO pins and prints their state every 100ms."]},{title:"Click Run",text:"Press the green Run button. The simulator compiles the program, loads it onto the virtual board, and starts execution. You will see UART output appear in the console within 1-2 seconds.",tip:"The GPIO pins on the right side of the board light up in real time as the program toggles them."},{title:"Interact with the Simulation",substeps:["Click any GPIO pin to toggle it manually — the program will read the new state","The UART console shows all output from the virtual board","Click Reset to restart the simulation from the beginning","Click Stop to pause execution at any point"]},{title:"What You Just Ran — The Source Code",text:"The LED Blink program is a complete EoS application:",code:`#include "eos/hal/gpio.h"
...
# Press Ctrl+C to stop`,tip:"Add --gui to open the graphical simulator with pin state visualization: ebuild sim --gui"},{title:"Switch to a Different Board",text:`EoSim supports ${n} platforms. Switch targets without changing your source code.`,code:`ebuild sim --platform esp32
...
# [app] EmbeddedOS v2.5.0 starting...
# [app] BME280 init OK
# [app] Temp: 22.8C, Humidity: 59.4%`,tip:"Because you simulated with the same BSP, the firmware should work on first boot with no changes needed."}],nextSteps:[{label:"ebuild CAD reference",href:"/flow"},{label:"HEALTH device CAD files",href:"/hardware-lab"},{label:"Add EAI to your design",href:"/eai"}]}};function Q(){const[r,k]=h.useState("nosim"),[p,u]=h.useState(null),E=async(t,i)=>{await j(t)&&(u(i),setTimeout(()=>u(null),2e3))};return e.jsxs("div",{className:"min-h-screen bg-[#080F1E]",children:[e.jsxs("section",{className:"relative py-20 sm:py-24 overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-[#0A1628] to-[#080F1E]"}),e.jsxs("div",{className:"absolute inset-0 pointer-events-none",children:[e.jsx("div",{className:"absolute top-1/3 left-1/4 w-80 h-80 bg-[#F97316]/5 rounded-full blur-[100px]"}),e.jsx("div",{className:"absolute top-1/4 right-1/3 w-64 h-64 bg-[#22D3EE]/4 rounded-full blur-[80px]"})]}),e.jsxs("div",{className:"relative max-w-5xl mx-auto px-4 sm:px-6 text-center",children:[e.jsx(s.div,{variants:o,initial:"hidden",animate:"visible",custom:0,children:e.jsxs("span",{className:"inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase mb-6",style:{background:"rgba(249,115,22,0.12)",border:"1px solid rgba(249,115,22,0.3)",color:"#F97316"},children:[e.jsx(S,{size:12})," Getting Started"]})}),e.jsxs(s.h1,{variants:o,initial:"hidden",animate:"visible",custom:1,className:"font-heading font-black text-5xl sm:text-6xl text-white mb-5 leading-[1.05]",children:["Start Building with",e.jsx("br",{}),e.jsx("span",{style:{color:"#F97316"},children:"EmbeddedOS"})]}),e.jsx(s.p,{variants:o,initial:"hidden",animate:"visible",custom:2,className:"text-white/60 text-xl max-w-2xl mx-auto mb-4 leading-relaxed",children:"No hardware required to get started. Choose your path below and go from zero to running firmware in minutes."}),e.jsxs(s.div,{variants:o,initial:"hidden",animate:"visible",custom:3,className:"inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm text-[#34D399]",style:{background:"rgba(52,211,153,0.08)",border:"1px solid rgba(52,211,153,0.2)"},children:[e.jsx(x,{size:14})," You can simulate ",n," ","platforms in your browser — no install, no hardware needed"]})]})]}),e.jsx("section",{className:"pb-16",children:e.jsxs("div",{className:"max-w-5xl mx-auto px-4 sm:px-6",children:[e.jsxs(s.div,{variants:o,initial:"hidden",whileInView:"visible",viewport:{once:!0},className:"text-center mb-8",children:[e.jsx("h2",{className:"font-heading font-black text-2xl text-white mb-2",children:"The EmbeddedOS Ecosystem"}),e.jsx("p",{className:"text-white/40 text-sm",children:"8 tools that work together — understand what each one does before you start"})]}),e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-4 gap-3",children:M.map((t,i)=>{const a=t.icon;return e.jsxs(s.div,{variants:o,initial:"hidden",whileInView:"visible",viewport:{once:!0},custom:i,className:"rounded-2xl border p-4",style:{background:`${t.color}06`,borderColor:`${t.color}20`},children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg flex items-center justify-center shrink-0",style:{background:`${t.color}18`},children:e.jsx(a,{size:14,style:{color:t.color}})}),e.jsxs("div",{children:[e.jsx("div",{className:"font-heading font-bold text-white text-sm",children:t.name}),e.jsx("div",{className:"text-[10px]",style:{color:t.color},children:t.role})]})]}),e.jsx("p",{className:"text-white/45 text-xs leading-relaxed",children:t.desc})]},t.id)})})]})}),e.jsx("section",{className:"pb-8",children:e.jsxs("div",{className:"max-w-5xl mx-auto px-4 sm:px-6",children:[e.jsxs(s.div,{variants:o,initial:"hidden",whileInView:"visible",viewport:{once:!0},className:"text-center mb-6",children:[e.jsx("h2",{className:"font-heading font-black text-2xl text-white mb-1",children:"Choose Your Path"}),e.jsx("p",{className:"text-white/40 text-sm",children:"Pick the option that matches where you are right now"})]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3",role:"tablist","aria-label":"Getting started paths",onKeyDown:P,children:R.map(t=>{const i=t.icon;return e.jsxs("button",{role:"tab",id:`path-tab-${t.id}`,"aria-selected":r===t.id,"aria-controls":`path-panel-${t.id}`,tabIndex:r===t.id?0:-1,onClick:()=>k(t.id),className:"relative flex items-center gap-3 p-4 rounded-2xl text-left transition-all",style:r===t.id?{background:`${t.color}15`,border:`1.5px solid ${t.color}50`}:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.08)"},children:[t.badge&&e.jsx("span",{className:"absolute top-2 right-2 px-2 py-0.5 rounded-full text-[10px] font-bold",style:{background:t.color,color:"#000"},children:t.badge}),e.jsx("div",{className:"w-10 h-10 rounded-xl flex items-center justify-center shrink-0",style:{background:r===t.id?`${t.color}25`:`${t.color}12`},children:e.jsx(i,{size:18,style:{color:t.color}})}),e.jsxs("div",{children:[e.jsx("div",{className:"font-heading font-bold text-white text-sm",children:t.label}),e.jsx("div",{className:"text-xs text-white/45",children:t.sublabel})]})]},t.id)})})]})}),e.jsx("section",{className:"pb-20",children:e.jsx("div",{className:"max-w-4xl mx-auto px-4 sm:px-6",children:Object.keys(g).map(t=>{const i=g[t];return e.jsxs("div",{role:"tabpanel",id:`path-panel-${t}`,"aria-labelledby":`path-tab-${t}`,hidden:t!==r,children:[e.jsxs("div",{className:"rounded-2xl border p-6 mb-6",style:{background:`${i.color}08`,borderColor:`${i.color}25`},children:[e.jsxs("div",{className:"flex flex-wrap items-center gap-3 mb-3",children:[e.jsx("h2",{className:"font-heading font-black text-2xl sm:text-3xl text-white",children:i.title}),e.jsx("span",{className:"px-3 py-1 rounded-full text-xs font-bold",style:{background:`${i.color}20`,color:i.color},children:i.time})]}),e.jsx("p",{className:"text-white/60 text-base mb-4 leading-relaxed",children:i.intro}),e.jsxs("div",{className:"flex items-start gap-2 p-3 rounded-xl",style:{background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)"},children:[e.jsx(B,{size:14,className:"text-white/40 mt-0.5 shrink-0"}),e.jsxs("div",{children:[e.jsxs("span",{className:"text-xs font-bold text-white/40 uppercase tracking-wider",children:["Prerequisites:"," "]}),e.jsx("span",{className:"text-xs text-white/60",children:i.prereq})]})]})]}),e.jsx("div",{className:"space-y-4",children:i.steps.map((a,l)=>e.jsxs(s.div,{variants:o,initial:"hidden",animate:"visible",custom:l,className:"rounded-2xl border border-white/8 overflow-hidden",style:{background:"rgba(255,255,255,0.02)"},children:[e.jsxs("div",{className:"flex items-center gap-3 px-5 py-4 border-b border-white/5",children:[e.jsx("div",{className:"w-7 h-7 rounded-lg flex items-center justify-center text-xs font-black text-white shrink-0",style:{background:`${i.color}25`,border:`1px solid ${i.color}40`},children:l+1}),e.jsx("h3",{className:"font-heading font-bold text-white",children:a.title})]}),e.jsxs("div",{className:"px-5 py-4 space-y-3",children:[a.text&&e.jsx("p",{className:"text-sm text-white/60 leading-relaxed",children:a.text}),a.substeps&&e.jsx("ul",{className:"space-y-1.5",children:a.substeps.map(b=>e.jsxs("li",{className:"flex items-start gap-2 text-sm text-white/55",children:[e.jsx(N,{size:13,className:"mt-0.5 shrink-0",style:{color:i.color}}),b]},b))}),a.code&&e.jsxs("div",{className:"relative rounded-xl overflow-hidden border border-white/8",style:{background:"rgba(5,10,20,0.9)"},children:[e.jsxs("div",{className:"flex items-center justify-between px-4 py-2 border-b border-white/5",children:[e.jsxs("div",{className:"flex gap-1.5",children:[e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-[#F85149]/50"}),e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-[#F0883E]/50"}),e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-[#3FB950]/50"})]}),e.jsxs("button",{onClick:()=>E(a.code,`${t}-${l}`),className:"flex items-center gap-1.5 text-xs text-white/30 hover:text-white/60 transition-colors",children:[p===`${t}-${l}`?e.jsx(x,{size:12,className:"text-[#34D399]"}):e.jsx(L,{size:12}),p===`${t}-${l}`?"Copied!":"Copy"]})]}),e.jsx("pre",{className:"p-4 text-xs overflow-x-auto font-mono leading-relaxed",children:e.jsx("code",{style:{color:"#E6EDF3"},children:a.code})})]}),a.tip&&e.jsxs("div",{className:"flex items-start gap-2 p-3 rounded-xl text-xs",style:{background:`${i.color}08`,border:`1px solid ${i.color}20`},children:[e.jsx(T,{size:12,style:{color:i.color},className:"mt-0.5 shrink-0"}),e.jsxs("span",{style:{color:i.color},children:[e.jsx("strong",{children:"Tip:"})," ",a.tip]})]}),a.warn&&e.jsxs("div",{className:"flex items-start gap-2 p-3 rounded-xl text-xs",style:{background:"rgba(248,81,73,0.08)",border:"1px solid rgba(248,81,73,0.2)"},children:[e.jsx(O,{size:12,className:"text-[#F85149] mt-0.5 shrink-0"}),e.jsxs("span",{className:"text-[#F85149]",children:[e.jsx("strong",{children:"Note:"})," ",a.warn]})]})]})]},a.title))}),e.jsxs("div",{className:"mt-8 rounded-2xl border border-white/8 p-5",style:{background:"rgba(255,255,255,0.02)"},children:[e.jsx("div",{className:"text-xs font-bold text-white/40 uppercase tracking-widest mb-3",children:"What's Next"}),e.jsx("div",{className:"flex flex-wrap gap-2",children:i.nextSteps.map(a=>e.jsxs(d,{href:a.href,className:"inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold text-white/70 hover:text-white transition-all",style:{background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)"},children:[a.label," ",e.jsx(I,{size:13})]},a.label))})]})]},t)})})}),e.jsx("section",{className:"pb-16",children:e.jsxs("div",{className:"max-w-5xl mx-auto px-4 sm:px-6",children:[e.jsxs(s.div,{variants:o,initial:"hidden",whileInView:"visible",viewport:{once:!0},className:"text-center mb-6",children:[e.jsx("h2",{className:"font-heading font-black text-2xl text-white mb-1",children:"Once it builds, where to look next"}),e.jsx("p",{className:"text-white/40 text-sm",children:"The pages that explain how the pieces fit together"})]}),e.jsx("div",{className:"grid sm:grid-cols-2 gap-3",children:[{href:"/architecture",label:"How EmbeddedOS is put together",desc:"The full stack, layer by layer, with the diagrams."},{href:"/ecosystem",label:"Every component and what it does",desc:"Each project, its purpose, and how they depend on each other."},{href:"/products",label:"The component reference pages",desc:"Engineering detail for each project, with usage examples."},{href:"/downloads",label:"Every repository and install command",desc:"All EmbeddedOS repositories, MIT licensed, in one list."},{href:"/stacks",label:"Pick a stack for your device",desc:"Which components you need for the kind of hardware you are building."}].map(t=>e.jsxs(d,{href:t.href,className:"block rounded-2xl border border-white/8 p-5 transition-all hover:border-white/20",style:{background:"rgba(255,255,255,0.02)"},children:[e.jsx("span",{className:"block font-bold text-white text-sm mb-1",children:t.label}),e.jsx("span",{className:"block text-white/50 text-xs leading-relaxed",children:t.desc})]},t.href))})]})}),e.jsx("section",{className:"pb-24",children:e.jsx("div",{className:"max-w-5xl mx-auto px-4 sm:px-6",children:e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3",children:[{label:"EoS Kernel",href:"/eos",color:"#F97316",icon:c},{label:"eBoot",href:"/eboot",color:"#F59E0B",icon:f},{label:"eFlow",href:"/flow",color:"#A78BFA",icon:y},{label:"EAI / ENI",href:"/eai",color:"#34D399",icon:w},{label:"eOffice",href:"/eoffice",color:"#22D3EE",icon:m},{label:"Hardware Lab",href:"/hardware-lab",color:"#60A5FA",icon:F}].map(t=>{const i=t.icon;return e.jsxs(d,{href:t.href,className:"flex flex-col items-center gap-2 p-4 rounded-2xl border text-center transition-all hover:scale-[1.02]",style:{background:`${t.color}08`,borderColor:`${t.color}20`},children:[e.jsx("div",{className:"w-10 h-10 rounded-xl flex items-center justify-center",style:{background:`${t.color}18`},children:e.jsx(i,{size:16,style:{color:t.color}})}),e.jsx("span",{className:"text-xs font-bold text-white/60",children:t.label})]},t.label)})})})})]})}export{Q as default};
