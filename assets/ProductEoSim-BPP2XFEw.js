import{j as t}from"./vendor-motion-DJ7isXre.js";import{P as r}from"./ProductDetailPage-Dt2TU-sO.js";import{S as e}from"./index-D0p4xz1q.js";import"./vendor-react-r7gXz3yt.js";import"./code-xml-B1V2lbd0.js";import"./circle-check-G0PaMe6u.js";function m(){return t.jsx(r,{badge:"Simulator",title:"EoSim — Virtual Platform Simulator",subtitle:`${e} Platforms · GPIO Visualizer · HIL Bridge · GDB Support`,description:`A full-system virtual platform simulator for EoS firmware. Run unmodified EoS binaries on ${e} simulated platforms — with a graphical GPIO pin visualizer, UART terminal, hardware-in-the-loop (HIL) bridge, and GDB debugging support.`,accent:"#06B6D4",gradient:"from-cyan-500/20 to-sky-600/20",lang:"C++ / Python",github:"embeddedos-org/eosim",heroImage:"/manus-storage/product-eosim-sim_78145da3.jpg",stackHighlight:"build / ide / sim",stats:[{value:`${e}`,label:"Simulated Platforms"},{value:"100%",label:"Binary Compatible"},{value:"< 5 ms",label:"Boot-to-Prompt"},{value:"HIL",label:"Hardware-in-the-Loop"}],workflow:[{step:1,title:"List Available Platforms",desc:`EoSim ships with ${e} pre-configured virtual platforms covering all major EoS reference boards. Use eosim list to browse them by architecture, MCU family, or peripheral set.`,code:`# List all platforms
eosim list
