import{j as e}from"./index-Dgv1uCQo.js";import{P as a}from"./ProductDetailPage-DonhfCSm.js";import"./code-xml-BYKgvMpB.js";import"./circle-check-Ccbbv0BM.js";function n(){return e.jsxDEV(a,{"data-loc":"client/src/pages/ProductEoS.tsx:5",badge:"Kernel",title:"EoS Kernel — Real-Time Embedded OS",subtitle:"7 Architectures · 33 HAL Drivers · < 1 µs IRQ Latency",description:"The deterministic, preemptive real-time kernel at the heart of every EoS device. Supports ARM Cortex-M/A/R, RISC-V, x86, MIPS, ARC, and Xtensa — with a unified HAL, capability-based security, and a < 4 KB minimum footprint.",accent:"#22D3EE",gradient:"from-cyan-500/20 to-blue-600/20",lang:"C11",github:"embeddedos-org/EoS",heroImage:"/manus-storage/product-eos-kernel_0ca24d8d.jpg",stackHighlight:"kernel",stats:[{value:"< 1 µs",label:"IRQ Latency (Cortex-M4)"},{value:"33",label:"HAL Peripheral Classes"},{value:"41",label:"BSP Profiles"},{value:"< 4 KB",label:"Minimum Footprint"}],workflow:[{step:1,title:"Select a BSP Profile",desc:"Pick one of 41 ready-made Board Support Package profiles that matches your hardware target. Each profile bundles the right HAL drivers, linker script, and clock configuration for that board.",code:`# List available profiles
