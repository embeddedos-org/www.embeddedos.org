import{j as e}from"./vendor-motion-DJ7isXre.js";import{P as i}from"./ProductDetailPage-Cx1CtQMU.js";import"./vendor-react-r7gXz3yt.js";import"./index-C_mVJP2y.js";import"./code-xml-C9di_OAb.js";import"./circle-check-C2u4PtGX.js";function l(){return e.jsx(i,{badge:"Build System",title:"eBuild — Build System & SDK Generator",subtitle:"18-Command CLI · 14 SDK Targets · Reproducible Builds",description:"The EoS build system and SDK generator. An 18-command CLI that compiles, signs, packages, and flashes firmware for all 41 BSP profiles. Generates per-component SDKs, runs reproducible builds, and integrates the full EoSim simulation pipeline.",accent:"#EF4444",gradient:"from-red-500/20 to-rose-600/20",lang:"Go",github:"embeddedos-org/ebuild",heroImage:"/manus-storage/product-eos-kernel_0ca24d8d.jpg",stackHighlight:"build",stats:[{value:"18",label:"CLI Commands"},{value:"14",label:"SDK Targets"},{value:"41",label:"BSP Profiles"},{value:"100%",label:"Reproducible Builds"}],workflow:[{step:1,title:"Initialize a Project",desc:"Run ebuild init to scaffold a new EoS project. Choose a BSP profile (board + architecture + peripheral set) and eBuild generates the CMakeLists.txt, linker script, and manifest.yml.",code:`# Create a new EoS project for STM32F4 Discovery
