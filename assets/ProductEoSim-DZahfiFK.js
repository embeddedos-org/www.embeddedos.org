import{j as e}from"./index-BDmB4CSh.js";import{P as t}from"./ProductDetailPage-DlFVyXvG.js";import"./code-xml-6p9uliNg.js";import"./circle-check-cQijA6w1.js";function s(){return e.jsxDEV(t,{"data-loc":"client/src/pages/ProductEoSim.tsx:5",badge:"Simulator",title:"EoSim — Virtual Platform Simulator",subtitle:"63+ Platforms · GPIO Visualizer · HIL Bridge · GDB Support",description:"A full-system virtual platform simulator for EoS firmware. Run unmodified EoS binaries on 63+ simulated boards — with a graphical GPIO pin visualizer, UART terminal, hardware-in-the-loop (HIL) bridge, and GDB debugging support.",accent:"#06B6D4",gradient:"from-cyan-500/20 to-sky-600/20",lang:"C++ / Python",github:"embeddedos-org/eosim",heroImage:"/images/product-eosim-sim.png",stackHighlight:"build / ide / sim",stats:[{value:"63+",label:"Simulated Platforms"},{value:"100%",label:"Binary Compatible"},{value:"< 5 ms",label:"Boot-to-Prompt"},{value:"HIL",label:"Hardware-in-the-Loop"}],workflow:[{step:1,title:"List Available Platforms",desc:"EoSim ships with 63+ pre-configured virtual platforms covering all major EoS reference boards. Use eosim list to browse them by architecture, MCU family, or peripheral set.",code:`# List all platforms
eosim list
