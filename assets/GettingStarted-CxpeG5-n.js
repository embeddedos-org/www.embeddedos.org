import{j as e,m as o,A as k}from"./vendor-motion-D7Nov3QW.js";import{r as u,L as b}from"./vendor-react-DdUyh3Gc.js";import{c as E}from"./clipboard-B9HKxd0_.js";import{P as x,S as l,C as h,W as P,a as d,b as g,L as f,B as y,c,d as A,e as j,f as C,g as _,h as T,A as N}from"./index-C2T_nuYj.js";import{M as w}from"./monitor-7PGv1kQm.js";import{P as I}from"./pen-tool-r8ko70nH.js";import{I as O}from"./info-iaslf9Hs.js";import{C as D}from"./copy-1UxHTWI8.js";import{H as B}from"./hard-drive-B13QPAGU.js";const s={hidden:{opacity:0,y:20},visible:(r=0)=>({opacity:1,y:0,transition:{duration:.45,delay:r*.07,ease:[.23,1,.32,1]}})},L=[{id:"ebuild",name:"ebuild",role:"Build Tool",desc:"Compiles, links, analyzes CAD, and flashes firmware. The single CLI for the entire EoS lifecycle.",color:"#F97316",icon:P},{id:"eosim",name:"EoSim",role:"Simulator",desc:`Runs your firmware in-browser on ${l} virtual platforms. No hardware required — ever.`,color:"#22D3EE",icon:w},{id:"eos",name:"EoS Kernel",role:"RTOS Kernel",desc:"The real-time OS kernel. Provides HAL, scheduler, IPC, drivers, and POSIX subset.",color:"#F97316",icon:d},{id:"eboot",name:"eBoot",role:"Bootloader",desc:"Secure bootloader with verified boot, OTA A/B updates, and hardware root of trust.",color:"#F59E0B",icon:g},{id:"eflow",name:"eFlow",role:"Visual Programming",desc:"Drag-and-drop block editor that generates production C code. No assembly needed for common patterns.",color:"#A78BFA",icon:f},{id:"eai",name:"EAI / ENI",role:"Edge AI",desc:"On-device TFLite/ONNX inference and neural interface adapter for BCI devices.",color:"#34D399",icon:y},{id:"eapps",name:"eApps",role:"App Ecosystem",desc:"60+ apps including eOffice Suite, eBrowser, eDB, and eBot AI assistant.",color:"#60A5FA",icon:c},{id:"eostudio",name:"EoStudio",role:"IDE",desc:"Universal IDE with AI tutor, 3D modeler, game editor, and UI designer.",color:"#F472B6",icon:A}],F=[{id:"nosim",icon:x,label:"No Hardware, No Install",sublabel:"Run in browser — 60 seconds",color:"#34D399",badge:"Fastest"},{id:"sim",icon:w,label:"Simulator on My Computer",sublabel:"Full EoSim CLI + ebuild",color:"#22D3EE"},{id:"esp32",icon:j,label:"I Have an ESP32",sublabel:"Flash EoS to $5 board",color:"#F97316"},{id:"stm32",icon:d,label:"I Have an STM32",sublabel:"Nucleo / Discovery board",color:"#22D3EE"},{id:"apps",icon:c,label:"I Want to Build eApps",sublabel:"C + LVGL cross-platform apps",color:"#F59E0B"},{id:"hardware-design",icon:I,label:"I'm a Hardware Engineer",sublabel:"CAD → ebuild → simulate → flash",color:"#A78BFA"}],M={nosim:{title:"Run EoS in Your Browser — No Install",color:"#34D399",intro:"EoSim runs entirely in your browser using WebAssembly. You can write, compile, and simulate firmware on a virtual STM32, ESP32, or Raspberry Pi Pico without installing anything. This is the fastest way to understand what EmbeddedOS is.",prereq:"A modern browser (Chrome 90+, Firefox 88+, Safari 15+). That is it.",time:"~5 minutes",steps:[{title:"Open the EoSim Demo",text:"Navigate to the EoSim demo page. You will see a virtual board with GPIO pins, a code editor, and a UART output console. No login required.",substeps:["Click 'Demo' in the top navigation, or go directly to /demo","The simulator loads a virtual STM32F4 board by default"]},{title:"Choose a Board",text:`EoSim supports ${l} virtual platforms. For your first run, keep the default STM32F4 Discovery. You can switch to ESP32 or Raspberry Pi Pico using the board selector.`,substeps:["STM32F4 — ARM Cortex-M4, 168MHz, 1MB flash","ESP32 — Xtensa LX6, 240MHz, Wi-Fi + BT","RPi Pico — RP2040, dual-core ARM Cortex-M0+"]},{title:"Select a Program",text:"Three example programs are pre-loaded:",substeps:["LED Blink — Toggles GPIO PA5 every 500ms. The simplest possible EoS program.","UART Echo — Reads from UART1 and echoes back. Demonstrates the EoS UART HAL.","GPIO Scanner — Reads all GPIO pins and prints their state every 100ms."]},{title:"Click Run",text:"Press the green Run button. The simulator compiles the program, loads it onto the virtual board, and starts execution. You will see UART output appear in the console within 1-2 seconds.",tip:"The GPIO pins on the right side of the board light up in real time as the program toggles them."},{title:"Interact with the Simulation",substeps:["Click any GPIO pin to toggle it manually — the program will read the new state","The UART console shows all output from the virtual board","Click Reset to restart the simulation from the beginning","Click Stop to pause execution at any point"]},{title:"What You Just Ran — The Source Code",text:"The LED Blink program is a complete EoS application:",code:`#include "eos/hal/gpio.h"
...
# Press Ctrl+C to stop`,tip:"Add --gui to open the graphical simulator with pin state visualization: ebuild sim --gui"},{title:"Switch to a Different Board",text:`EoSim supports ${l} platforms. Switch targets without changing your source code.`,code:`ebuild sim --platform esp32
